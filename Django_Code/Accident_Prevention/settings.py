...
SECRET_KEY = 'django-insecure-ebez=_dbvr(-+1gi7d%^_)hvxuqt_7g1)c^3sbfqvp%ryz(&_f'
...
ROOT_URLCONF = 'Accident_Prevention.urls'
...
WSGI_APPLICATION = 'Accident_Prevention.wsgi.application'
